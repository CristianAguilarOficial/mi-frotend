...
function RegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center h-screen ">
      <div className=" max-w-md w-full p-8 rounded-xl shadow-lg border-blue-500 border-2 ">
        {registrationSuccess ? (
          ...
          <>
            ...
            <form onSubmit={onSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 hover:bg-blue-700 transition-colors text-white px-4 py-2 rounded-md my-4"
              >
                Registrarse
              </button>
            </form>
